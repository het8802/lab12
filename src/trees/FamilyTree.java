...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		else
		{
			...
			if (parentNode == null)
				throw new TreeException("File does not contain parent node."); 	// If the parent node wasn't found, there must have been something wrong in the 
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node2 == null)
			throw new TreeException(name2 + " is not found.");	// Throw TreeException with a useful message
